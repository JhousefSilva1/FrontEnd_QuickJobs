...
abstract class AuthState {
  UserModel user;
  bool isAuth;
  AuthState({required this.user, this.isAuth = false});
...
class AuthSuccessState extends AuthState {
  final UserModel newUser;
  bool isAuth;
  AuthSuccessState({required this.newUser, this.isAuth = true})
      : super(user: newUser);
}
...
class AuthFailedState extends AuthState {
  final UserModel newUser;
  bool isAuth;
  AuthFailedState({required this.newUser, this.isAuth = false})
      : super(user: newUser);
}
